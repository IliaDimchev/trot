...
def home():
    if request.method == "POST":
        ...
        try:
            ...
            content = Message(
                subject=str(
                    Header("БОНУС! Как се открием точния размер гуми за електрическа тротинетка!", 'utf-8')),
                recipients=[email],
                sender=formatted_sender,
                charset='utf-8')
            ...
            content.body = (
                ...
                "Сега ще разясним мистерията зад това съкращение при гумите на електрическите тротинетки и скутери!\n\n"
                "Размер на гуми 80/65-6 означава следното:\n"
                "80 е широчината на гумата в милиметри\n"
                "65 е 65% от широчината - 80, което е 52 милиметра и това е височината на страничната й стена\n"
                "6 е вътрешният диаметър на гумата в инчове - 6 * 2.54 ни дава 15.24 в сантиметри\n\n"
                "Остава само да измерите вашата. Така ще узнаете размера й, ако никъде не го пише или не успявате да го откриете.\n\n"
                "Поздрави,\nTROT.BG")
